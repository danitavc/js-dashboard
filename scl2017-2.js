var titulo = document.getElementById('titulo');
	...
	h1.innerHTML = 'Alumnas Santiago de Chile 2017-2';
	...
	for (var i=0; i<data.SCL['2017-2'].students.length; i++) {
		...
		var photo = data.SCL['2017-2'].students[i].photo;
		var paragraphName = data.SCL['2017-2'].students[i].name;
		var sprintsData = data.SCL['2017-2'].students[i].sprints.number;
