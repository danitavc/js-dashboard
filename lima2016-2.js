	...
	h1.innerHTML = 'Alumnas Lima 2016-2';
	...
	for (var i=0; i<data.LIM['2016-2'].students.length; i++) {
		...
		var photo = data.LIM['2016-2'].students[i].photo;
		var paragraphName = data.LIM['2016-2'].students[i].name;
		var sprintsData = data.LIM['2016-2'].students[i].sprints.number;
