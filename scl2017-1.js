var titulo = document.getElementById('titulo');
	...
	h1.innerHTML = 'Alumnas Santiago de Chile 2017-1';
	...
	for (var i=0; i<data.SCL['2017-1'].students.length; i++) {
		...
		var photo = data.SCL['2017-1'].students[i].photo;
		var paragraphName = data.SCL['2017-1'].students[i].name;
		var sprintsData = data.SCL['2017-1'].students[i].sprints.number;
